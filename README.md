...
- Next, this seems like the perfect project to learn how to build a neural network or some form of machine learning. I have data and need an answer. The data will be collected into a form to be used in model training. 
